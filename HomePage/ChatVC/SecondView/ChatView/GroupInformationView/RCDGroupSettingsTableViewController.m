...
//                                          NSLog(@"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~%@",result);
                                          ...
                                          if ([result count] > 0) {
                                              ...
                                              NSArray *resultList = [[RCDUserInfoManager shareInstance] getFriendInfoList:_GroupMemberList];
                                              _GroupMemberList = [[NSMutableArray alloc] initWithArray:resultList];
                                              [collectionViewResource addObjectsFromArray:_GroupMemberList];
                                              [self setHeaderView];
                                              [self.tableView reloadData];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView
    ...
    [collectionView dequeueReusableCellWithReuseIdentifier:@"RCDConversationSettingTableViewHeaderItem" forIndexPath:indexPath];
...
- (void)setHeaderView {
    ...
    UIImage *addImage = [UIImage imageNamed:@"pic_add"];
...
//    [collectionViewResource addObject:addImage];
    //判断如果是创建者，添加踢人按钮
    if (isCreator == YES) {
        UIImage *delImage = [UIImage imageNamed:@"pic_delete"];
