...
- (void)initSubviews {
    ...
    self.selectedImageView.image = [UIImage imageNamed:@"CellNotSelected"];
...
- (void)setModel:(RCDUserInfo *)user {
    if (user) {
        ...
        if ([user.portraitUri isEqualToString:@""]) {
            ...
            [self.portraitImageView sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",user.portraitUri]]];
        }
    }
...
- (void)setSelected:(BOOL)selected {
    ...
    if (selected) {
        _selectedImageView.image = [UIImage imageNamed:@"CellBlueSelected"];
    } else {
        _selectedImageView.image = [UIImage imageNamed:@"CellNotSelected"];
    }
