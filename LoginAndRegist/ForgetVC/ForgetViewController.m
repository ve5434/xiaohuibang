...
- (void)viewDidLoad {
    ...
    self.nextBtn.backgroundColor = [UIColor colorWithRed:29.0/255.0 green:141.0/255.0 blue:239.0/255.0 alpha:1.0];
    self.nextBtn.layer.cornerRadius = 5;
    self.nextBtn.layer.masksToBounds = YES;
}

- (IBAction)clearPhoneNumberButtonClick:(UIButton *)sender {
