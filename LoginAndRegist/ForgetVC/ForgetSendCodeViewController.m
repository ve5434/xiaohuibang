//
//  ForgetSendCodeViewController.m
//  XiaoHuiBang
//
...
#import "ForgetSendCodeViewController.h"

@interface ForgetSendCodeViewController ()

@end

@implementation ForgetSendCodeViewController
...
- (void)viewDidLoad {
    ...
    self.verifyBtn.backgroundColor = [UIColor colorWithRed:29.0/255.0 green:141.0/255.0 blue:239.0/255.0 alpha:1.0];
    self.verifyBtn.layer.cornerRadius = 5;
    self.verifyBtn.layer.masksToBounds = YES;
}

- (IBAction)clearCodeButtonClick:(UIButton *)sender {
    
}

- (IBAction)validationNextViewClick:(UIButton *)sender {
